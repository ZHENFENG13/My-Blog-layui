$(function () {
    ...
    function statusFormatter(cellvalue) {
        return "<button type=\"button\" class=\"btn btn-block btn-secondary btn-sm\" style=\"width: 50%;\">删除</button>";
    }
...
function search() {
    ...
    //提交post并刷新表格
    $("#jqGrid").jqGrid("setGridParam", {url: '/admin/blogs/list/1'}).trigger("reloadGrid");
}
