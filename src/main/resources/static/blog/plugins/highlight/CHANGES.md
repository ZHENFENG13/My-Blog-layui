...
[p]: http://softwaremaniacs.org/blogInfo/2012/05/10/http-and-json-in-highlight-js/en/
...
Developer overview of the new language syntax is available in a [blogInfo post about
recent beta release][beta].

[beta]: http://softwaremaniacs.org/blogInfo/2011/04/25/highlight-js-60-beta/en/
...
[my wife's blogInfo][alenacpp] had issues with it from time to time). And lastly
